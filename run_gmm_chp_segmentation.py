...
subj = sys.argv[2]
max_iter = sys.argv[3]
subjects_dir='/home/hackerman/bds/bids/derivatives/freesurfer-T1w'
subj='sub-10'
max_iter = 1000
### Set up logging for warning catching
logfile='./{sub}_log.txt'.format(sub=subj)
...
choroid_gmmb_susan_img = nib.load('{subjects_dir}/{subj}/mri/rh_choroid_gmmb_mask_susan.nii.gz'.format(subjects_dir=subjects_dir, subj=subj))
choroid_gmmb_susan = np.asanyarray(choroid_gmmb_susan_img.dataobj)
